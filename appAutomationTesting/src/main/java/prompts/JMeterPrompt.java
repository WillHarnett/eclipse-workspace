...
public class JMeterPrompt {
	...
	public boolean prompt() {
		...
		int result = JOptionPane.showConfirmDialog(null, panel, "JMeter Variables", JOptionPane.OK_CANCEL_OPTION,
	...
	public void updateGlobalVariables() {
		...
		System.out.println("Finished JMeter Testing Setup");
	}
